...
public:
	...
	void* GetEntityByIndex(int nIndex) {
		...
		using GetBaseEntity_t = void* (__thiscall*)(void*, int);
		static auto fnGetBaseEntity = reinterpret_cast<GetBaseEntity_t>(MEM::FindPattern2(CLIENT_DLL, CS_XOR("81 FA ? ? ? ? 77 ? 8B C2 C1 F8 ? 83 F8 ? 77 ? 48 98 48 8B 4C C1 ? 48 85 C9 74 ? 8B C2 25 ? ? ? ? 48 6B C0 ? 48 03 C8 74 ? 8B 41 ? 25 ? ? ? ? 3B C2 75 ? 48 8B 01")).get());
