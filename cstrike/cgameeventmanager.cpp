...
int CGameEvent::GetInt2(const char* Name, bool Unk) {
    ...
    static GetEventInt_t GetEventInt = reinterpret_cast<GetEventInt_t>(MEM::FindPattern2(CLIENT_DLL, "48 89 5C 24 08 48 89 74 24 10 48 89 7C 24 18 41 56 48 83 EC 30 48 8B 01 41 8B F0 4C 8B F1 41 B0 01 48 8D 4C 24 20 48 8B DA 48 8B 78").get());
...
float CGameEvent::GetFloat2(const char* Name, bool Unk) {
    ...
    static GetEventFloat_t GetEventFloat = reinterpret_cast<GetEventFloat_t>(MEM::FindPattern2(CLIENT_DLL, "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 40 48 8B 01 48 8B F1 0F 29 74 24 30 48 8D 4C 24 20 0F 28 F2 48 8B DA 48 8B 78").get());
